...
unsafe extern "C" {
    ...
    pub fn LLVMContextGetDiagnosticContext(C: LLVMContextRef) -> *mut c_void;
    ...
    pub fn LLVMGetMDKindID(Name: *const c_char, SLen: c_uint) -> c_uint;

    /// Maps a synchronization scope name to a ID unique within this context.
    pub fn LLVMGetSyncScopeID(C: LLVMContextRef, Name: *const c_char, SLen: size_t);
    ...
    pub fn LLVMGetLastEnumAttributeKind() -> c_uint;
    ...
    pub fn LLVMGetEnumAttributeKind(A: LLVMAttributeRef) -> c_uint;
    ...
    pub fn LLVMGetTypeByName2(C: LLVMContextRef, Name: *const c_char) -> LLVMTypeRef;
}
...
unsafe extern "C" {
    ...
    pub fn LLVMGetDataLayout(M: LLVMModuleRef) -> *const c_char;
    /// Obtain the data layout for a module.
    pub fn LLVMGetDataLayoutStr(M: LLVMModuleRef) -> *const c_char;
    ...
    pub fn LLVMSetModuleInlineAsm(M: LLVMModuleRef, Asm: *const c_char);
    ...
    pub fn LLVMGetTypeByName(M: LLVMModuleRef, Name: *const c_char) -> LLVMTypeRef;
    ...
    pub fn LLVMGetDebugLocLine(Val: LLVMValueRef) -> c_uint;
    pub fn LLVMGetDebugLocColumn(Val: LLVMValueRef) -> c_uint;
...
unsafe extern "C" {
    ...
    pub fn LLVMArrayType(ElementType: LLVMTypeRef, ElementCount: c_uint) -> LLVMTypeRef;
    ...
    pub fn LLVMGetArrayLength(ArrayTy: LLVMTypeRef) -> c_uint;
    ...
    pub fn LLVMPointerTypeInContext(C: LLVMContextRef, AddressSpace: c_uint)
        -> LLVMTypeRef;
    ...
    pub fn LLVMGetTargetExtTypeName(TargetExtTy: LLVMTypeRef) -> *const c_char;

    /// Obtain the number of type parameters for this target extension type.
    pub fn LLVMGetTargetExtTypeNumTypeParams(TargetExtTy: LLVMTypeRef) -> c_uint;
    ...
    pub fn LLVMGetTargetExtTypeNumIntParams(TargetExtTy: LLVMTypeRef) -> c_uint;
...
unsafe extern "C" {
    ...
    pub fn LLVMGetValueName(Val: LLVMValueRef) -> *const c_char;
    pub fn LLVMGetValueName2(
        Val: LLVMValueRef,
        Length: *mut size_t,
    ) -> *const c_char;
    #[deprecated(since = "70.0.0", note = "Use LLVMSetValueName2 instead")]
    pub fn LLVMSetValueName(Val: LLVMValueRef, Name: *const c_char);
    ...
    pub fn LLVMPrintDbgRecordToString(Record: LLVMDbgRecordRef) -> *mut c_char;
    ...
    pub fn LLVMConstRealOfString(RealTy: LLVMTypeRef, Text: *const c_char) -> LLVMValueRef;
    pub fn LLVMConstRealOfStringAndSize(
        RealTy: LLVMTypeRef,
        Text: *const c_char,
        SLen: c_uint,
    ) -> LLVMValueRef;
    pub fn LLVMConstIntGetZExtValue(ConstantVal: LLVMValueRef) -> c_ulonglong;
    pub fn LLVMConstIntGetSExtValue(ConstantVal: LLVMValueRef) -> c_longlong;
    ...
    pub fn LLVMGetAsString(C: LLVMValueRef, Length: *mut size_t) -> *const c_char;
    ...
    pub fn LLVMGetRawDataValues(c: LLVMValueRef, SizeInBytes: usize) -> *const c_char;
    ...
    pub fn LLVMGetElementAsConstant(C: LLVMValueRef, idx: c_uint) -> LLVMValueRef;
    ...
    pub fn LLVMGetSection(Global: LLVMValueRef) -> *const c_char;
    ...
    pub fn LLVMGetAlignment(V: LLVMValueRef) -> c_uint;
    pub fn LLVMSetAlignment(V: LLVMValueRef, Bytes: c_uint);

    pub fn LLVMGlobalSetMetadata(Global: LLVMValueRef, Kind: c_uint, MD: LLVMMetadataRef);
    pub fn LLVMGlobalEraseMetadata(Global: LLVMValueRef, Kind: c_uint);
    ...
    pub fn LLVMGetIntrinsicID(Fn: LLVMValueRef) -> c_uint;
    ...
    pub fn LLVMIntrinsicIsOverloaded(ID: c_uint) -> LLVMBool;
    pub fn LLVMGetFunctionCallConv(Fn: LLVMValueRef) -> c_uint;
    pub fn LLVMSetFunctionCallConv(Fn: LLVMValueRef, CC: c_uint);
    pub fn LLVMGetGC(Fn: LLVMValueRef) -> *const c_char;
    pub fn LLVMSetGC(Fn: LLVMValueRef, Name: *const c_char);
    ...
    pub fn LLVMSetParamAlignment(Arg: LLVMValueRef, Align: c_uint);
}
...
unsafe extern "C" {
    ...
    #[deprecated(since = "90.0.0", note = "Use LLVMMDStringInContext2 instead.")]
    pub fn LLVMMDString(Str: *const c_char, SLen: c_uint) -> LLVMValueRef;
    ...
    #[deprecated(since = "90.0.0", note = "Use LLVMMDNodeInContext2 instead.")]
    pub fn LLVMMDNode(Vals: *mut LLVMValueRef, Count: c_uint) -> LLVMValueRef;
    ...
    pub fn LLVMGetNumOperandBundleArgs(Bundle: LLVMOperandBundleRef) -> c_uint;
    ...
    pub fn LLVMGetMDString(V: LLVMValueRef, Len: *mut c_uint) -> *const c_char;
    pub fn LLVMGetMDNodeNumOperands(V: LLVMValueRef) -> c_uint;
...
unsafe extern "C" {
    ...
    pub fn LLVMGetBasicBlockName(BB: LLVMBasicBlockRef) -> *const c_char;
    ...
    pub fn LLVMAppendBasicBlock(Fn: LLVMValueRef, Name: *const c_char)
        -> LLVMBasicBlockRef;
...
// Core->Instructions
unsafe extern "C" {
    pub fn LLVMHasMetadata(Val: LLVMValueRef) -> c_int;
    pub fn LLVMGetMetadata(Val: LLVMValueRef, KindID: c_uint) -> LLVMValueRef;
    pub fn LLVMSetMetadata(Val: LLVMValueRef, KindID: c_uint, Node: LLVMValueRef);
    ...
    pub fn LLVMGetNumArgOperands(Instr: LLVMValueRef) -> c_uint;
    pub fn LLVMSetInstructionCallConv(Instr: LLVMValueRef, CC: c_uint);
    pub fn LLVMGetInstructionCallConv(Instr: LLVMValueRef) -> c_uint;
    ...
    pub fn LLVMGetNumOperandBundles(C: LLVMValueRef) -> c_uint;
    ...
    pub fn LLVMGetCallBrNumIndirectDests(CallBr: LLVMValueRef) -> c_uint;
    ...
    pub fn LLVMGetNumSuccessors(Term: LLVMValueRef) -> c_uint;
    pub fn LLVMGetSuccessor(Term: LLVMValueRef, i: c_uint) -> LLVMBasicBlockRef;
    pub fn LLVMSetSuccessor(Term: LLVMValueRef, i: c_uint, block: LLVMBasicBlockRef);
    ...
    pub fn LLVMCountIncoming(PhiNode: LLVMValueRef) -> c_uint;
    pub fn LLVMGetIncomingValue(PhiNode: LLVMValueRef, Index: c_uint) -> LLVMValueRef;
    pub fn LLVMGetIncomingBlock(PhiNode: LLVMValueRef, Index: c_uint) -> LLVMBasicBlockRef;
}
...
unsafe extern "C" {
    ...
    pub fn LLVMGetNumIndices(Inst: LLVMValueRef) -> c_uint;
    pub fn LLVMGetIndices(Inst: LLVMValueRef) -> *const c_uint;
}
...
unsafe extern "C" {
    ...
    pub fn LLVMGetNumClauses(LandingPad: LLVMValueRef) -> c_uint;

    /// Get the value of the clause with the given index on a landingpad instruction.
    pub fn LLVMGetClause(LandingPad: LLVMValueRef, Idx: c_uint) -> LLVMValueRef;
    ...
    pub fn LLVMGetNumHandlers(CatchSwitch: LLVMValueRef) -> c_uint;
    ...
    pub fn LLVMGetArgOperand(Funclet: LLVMValueRef, i: c_uint) -> LLVMValueRef;

    /// Set a funcletpad argument at the given index.
    pub fn LLVMSetArgOperand(Funclet: LLVMValueRef, i: c_uint, value: LLVMValueRef);
    ...
    pub fn LLVMGetNumMaskElements(ShuffleVectorInst: LLVMValueRef) -> c_uint;
    pub fn LLVMGetUndefMaskElem() -> c_int;
    pub fn LLVMGetMaskValue(ShuffleVectorInst: LLVMValueRef, Elt: c_uint) -> c_int;
    ...
    pub fn LLVMGetAtomicSyncScopeID(AtomicInst: LLVMValueRef) -> c_uint;
    /// Sets the synchronization scope ID of an atomic instruction.
    pub fn LLVMSetAtomicSyncScopeID(AtomicInst: LLVMValueRef, SSID: c_uint);
