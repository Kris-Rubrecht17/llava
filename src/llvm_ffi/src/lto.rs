...
use super::prelude::{c_void,c_char,c_int,size_t,c_uint,off_t};
...
unsafe extern "C" {
    pub fn lto_get_version() -> *const c_char;
    pub fn lto_get_error_message() -> *const c_char;
    pub fn lto_module_is_object_file(path: *const c_char) -> lto_bool_t;
    ...
    pub fn lto_module_create(path: *const c_char) -> lto_module_t;
    ...
    pub fn lto_module_get_target_triple(_mod: lto_module_t) -> *const c_char;
    pub fn lto_module_set_target_triple(_mod: lto_module_t, triple: *const c_char);
    pub fn lto_module_get_num_symbols(_mod: lto_module_t) -> c_uint;
    ...
    pub fn lto_module_get_num_asm_undef_symbols(mod_: lto_module_t) -> c_uint;
    ...
    ///
    /// Added in LLVM 3.7.
    pub fn lto_module_get_linkeropts(_mod: lto_module_t) -> *const c_char;
    pub fn lto_module_get_macho_cputype(
        _mod: lto_module_t,
        out_cputype: *mut c_uint,
        out_cpusubtype: *mut c_uint,
    ) -> lto_bool_t;
    ...
    pub fn lto_codegen_set_cpu(cg: lto_code_gen_t, cpu: *const c_char);
    pub fn lto_codegen_set_assembler_path(cg: lto_code_gen_t, path: *const c_char);
    pub fn lto_codegen_set_assembler_args(
        cg: lto_code_gen_t,
        args: *mut *const c_char,
        nargs: c_int,
    );
    pub fn lto_codegen_add_must_preserve_symbol(cg: lto_code_gen_t, symbol: *const c_char);
    ...
    ///
    /// Added in LLVM 3.7.
    pub fn lto_api_version() -> c_uint;
    pub fn lto_set_debug_options(options: *mut *const c_char, number: c_int);
    pub fn lto_codegen_debug_options(cg: lto_code_gen_t, arg1: *const c_char);
...
unsafe extern "C" {
    ...
    /// to.
    pub fn thinlto_module_get_num_objects(cg: thinlto_code_gen_t) -> c_int;
    ...
    pub fn thinlto_module_get_num_object_files(cg: thinlto_code_gen_t) -> c_uint;
    ...
    pub fn thinlto_codegen_set_cache_dir(cg: thinlto_code_gen_t, cache_dir: *const c_char);
    ...
    pub fn lto_input_get_num_dependent_libraries(input: lto_input_t) -> c_uint;
    ...
    pub fn lto_runtime_lib_symbols_list(size: *mut usize) -> *const *const c_char;
    ...
    pub fn thinlto_codegen_set_cpu(cg: thinlto_code_gen_t, cpu: *const c_char);
    ...
    pub fn thinlto_debug_options(options: *const *const c_char, number: c_int);
