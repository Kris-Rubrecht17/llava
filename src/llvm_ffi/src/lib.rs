...
pub mod prelude {
    pub type c_double = std::ffi::c_double;
    pub type c_longlong = std::ffi::c_longlong;
    pub type c_ulonglong = std::ffi::c_ulonglong;
...
pub const LLVMAttributeReturnIndex: c_uint = 0;
pub const LLVMAttributeFunctionIndex: c_uint = !0; // -1
...
pub const LLVMFastMathAllowReassoc: c_uint = 1 << 0;
pub const LLVMFastMathNoNaNs: c_uint = 1 << 1;
pub const LLVMFastMathNoInfs: c_uint = 1 << 2;
pub const LLVMFastMathNoSignedZeros: c_uint = 1 << 3;
pub const LLVMFastMathAllowReciprocal: c_uint = 1 << 4;
pub const LLVMFastMathAllowContract: c_uint = 1 << 5;
pub const LLVMFastMathApproxFunc: c_uint = 1 << 6;
pub const LLVMFastMathNone: c_uint = 0;
pub const LLVMFastMathAll: c_uint = LLVMFastMathAllowReassoc
    | LLVMFastMathNoNaNs
    | LLVMFastMathNoInfs
...
pub type LLVMDiagnosticHandler =
    Option<extern "C" fn(arg1: LLVMDiagnosticInfoRef, arg2: *mut c_void)>;
