...
pub type LLVMDWARFTypeEncoding = c_uint;
...
unsafe extern "C" {
    ...
    pub fn LLVMDebugMetadataVersion() -> c_uint;
    /// The version of debug metadata that's present in the provided Module.
    pub fn LLVMGetModuleDebugMetadataVersion(Module: LLVMModuleRef) -> c_uint;
    ...
    pub fn LLVMDILocationGetLine(Location: LLVMMetadataRef) -> c_uint;

    /// Get the column number of this debug location.
    pub fn LLVMDILocationGetColumn(Location: LLVMMetadataRef) -> c_uint;
    ...
    pub fn LLVMDITypeGetLine(DType: LLVMMetadataRef) -> c_uint;
    ...
    pub fn LLVMDIVariableGetLine(Var: LLVMMetadataRef) -> c_uint;
    ...
    pub fn LLVMDISubprogramGetLine(Subprogram: LLVMMetadataRef) -> c_uint;
