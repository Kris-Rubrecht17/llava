...
unsafe extern "C" {
    ...
    pub fn LLVMRemarkStringGetData(String: LLVMRemarkStringRef) -> *const c_char;
...
unsafe extern "C" {
    ...
    pub fn LLVMRemarkParserCreateYAML(Buf: *const c_void, Size: u64)
        -> LLVMRemarkParserRef;
    ...
    pub fn LLVMRemarkParserGetErrorMessage(Parser: LLVMRemarkParserRef) -> *const c_char;
