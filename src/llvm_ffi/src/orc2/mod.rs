...
pub type LLVMOrcErrorReporterFunction = unsafe extern "C" fn(Ctx: *mut c_void, Err: LLVMErrorRef);
...
pub type LLVMOrcMaterializationUnitMaterializeFunction =
    unsafe extern "C" fn(Ctx: *mut c_void, MR: LLVMOrcMaterializationResponsibilityRef);

pub type LLVMOrcMaterializationUnitDiscardFunction = unsafe extern "C" fn(
    Ctx: *mut c_void,
    JD: LLVMOrcJITDylibRef,
    Symbol: LLVMOrcSymbolStringPoolEntryRef,
);

pub type LLVMOrcMaterializationUnitDestroyFunction = unsafe extern "C" fn(Ctx: *mut c_void);
...
/// is destroyed.
pub type LLVMOrcDisposeCAPIDefinitionGeneratorFunction = unsafe extern "C" fn(Ctx: *mut c_void);

pub type LLVMOrcSymbolPredicate = Option<
    unsafe extern "C" fn(Ctx: *mut c_void, Sym: LLVMOrcSymbolStringPoolEntryRef) -> c_int,
>;
...
pub type LLVMOrcGenericIRModuleOperationFunction =
    unsafe extern "C" fn(Ctx: *mut c_void, M: LLVMModuleRef) -> LLVMErrorRef;
...
pub type LLVMOrcIRTransformLayerTransformFunction = unsafe extern "C" fn(
    Ctx: *mut c_void,
...
pub type LLVMOrcObjectTransformLayerTransformFunction =
    unsafe extern "C" fn(Ctx: *mut c_void, ObjInOut: *mut LLVMMemoryBufferRef) -> LLVMErrorRef;
...
pub type LLVMOrcExecutionSessionLookupHandleResultFunction = unsafe extern "C" fn(
    Err: LLVMErrorRef,
